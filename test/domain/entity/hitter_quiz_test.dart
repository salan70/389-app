...
void main() {
  ...
  final baseHitterQuiz = dummyHitterQuiz.copyWith(
    isCorrect: true,
    incorrectCount: 0,
    unveilCount: 0,
  ...
  group('quiz.unveilRate', () {
    test('0(0/20)', () {
      // Arrange
      final hitterQuiz = baseHitterQuiz;

      // Act
      final result = hitterQuiz.unveilRate;
    ...
    test('0.35(7/20)', () {
      // Arrange
      final hitterQuiz = baseHitterQuiz.copyWith(
        unveilCount: 7,
      );
  ...
  group('quiz.resultRank', () {
    test('incorrect', () {
      ...
      // Act
      final result = hitterQuiz.resultRank;
